...
//$r = db_exec("SELECT * FROM users LIMIT 20", $my, __FILE__, __LINE__);
//db_show($r,"r");
...
$do_users        = true;
$do_enrollments  = true;
$do_penrollments = true;
$do_profhooks    = true;
$do_oldchoice    = true;
$do_createsurvey = true;
$do_topics       = true;
$do_getcustoms   = true;
$do_results      = true;
...
if ($do_createsurvey)
{
  ...
  pg_query("
    INSERT INTO choice_components (revision_id,type,parent,branch_id,revision,save_id,merged,ctext,is_html,choices,other_choice,first_number,last_number,is_numeric,select_many,stacked,vertical,rows) VALUES (11,2,NULL,13,1,NULL,NULL,'','f','{excellent,very good,satisfactory,poor,disastrous}','',5,1,'f','f','f','f',0);
    INSERT INTO choice_components (revision_id,type,parent,branch_id,revision,save_id,merged,ctext,is_html,choices,other_choice,first_number,last_number,is_numeric,select_many,stacked,vertical,rows) VALUES (31,2,NULL,33,1,NULL,NULL,'','f','{not at all,a great deal}','',0,5,'t','f','t','f',0);
    INSERT INTO choice_components (revision_id,type,parent,branch_id,revision,save_id,merged,ctext,is_html,choices,other_choice,first_number,last_number,is_numeric,select_many,stacked,vertical,rows) VALUES (39,2,NULL,40,1,NULL,NULL,'','f','{excellent,very good,satisfactory,poor,disastrous}','',5,1,'f','f','f','f',0);
  ...
  pg_query("
    INSERT INTO textresponse_components (revision_id,type,parent,branch_id,revision,save_id,merged,ctext,is_html,rows,cols) VALUES (12,3,NULL,14,1,NULL,NULL,'Comments:','f',5,60);
    INSERT INTO textresponse_components (revision_id,type,parent,branch_id,revision,save_id,merged,ctext,is_html,rows,cols) VALUES (33,3,NULL,34,1,NULL,NULL,'<strong>Enter a TA name:</strong> <small>(leave blank to rate all TA''s together)</small>','t',0,25);
    INSERT INTO textresponse_components (revision_id,type,parent,branch_id,revision,save_id,merged,ctext,is_html,rows,cols) VALUES (40,3,NULL,41,1,NULL,NULL,'Comments:','f',5,40);
  ...
  pg_query("    
    ...
    INSERT INTO wces_topics (topic_id,parent) VALUES (1,NULL);
    INSERT INTO topics (topic_id,parent) VALUES (2,NULL);
